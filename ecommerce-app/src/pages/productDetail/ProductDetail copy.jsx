...
const ProductDetail = () => {
  // Lấy id product cần xem detail
  const { id } = useParams()
  console.log(id)
  // Khởi tạo product ban đầu bằng null rồi set vào một hàm setProduct để thay đổi giá trị
  const [product, setProduct] = useState(null)
  const [amount, setAmount] = useState(1)

  console.log(product)

  // Lấy dữ liệu từ firestore trong firebase
